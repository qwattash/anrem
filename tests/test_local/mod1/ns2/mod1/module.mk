...
$(call anrem-local-set, module-var, ns2_variable_in_module_1)

$(call anrem-ns-local-set, ns-var-mod1, ns2_ns-variable-from-mod1)


$(call anrem-test):
	$(call anrem-warn, local ns2_|MODULE 1)
	$(call anrem-assert-eq, anrem-local-get module-var in mod1, ns2_variable_in_module_1, $(call anrem-local-get, module-var)) 
	$(call anrem-assert-eq, anrem-ns-local-get ns-var-mod1, ns2_ns-variable-from-mod1, $(call anrem-ns-local-get, ns-var-mod1))
	$(call anrem-assert-eq, @ module-var in mod1, ns2_variable_in_module_1, $(@module-var)) 
