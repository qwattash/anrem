...
$(<@)
$(@)module-var := ns2_variable_in_module_3
$(@>)

$(<&)
$(&)ns-var-mod3 := ns2_ns-variable-from-mod3
$(&>)


$(call anrem-test):
	$(call anrem-warn, local ns2_|MODULE 3)
	$(call anrem-assert-eq, anrem-local-get module-var in mod3, ns2_variable_in_module_3, $(call anrem-local-get, module-var)) 
	$(call anrem-assert-eq, anrem-ns-local-get ns-var-mod3, ns2_ns-variable-from-mod3, $(call anrem-ns-local-get, ns-var-mod3))
	$(call anrem-assert-eq, @ module-var in mod3, ns2_variable_in_module_3, $(@module-var)) 
