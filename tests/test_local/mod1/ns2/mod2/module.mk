...
$(call anrem-local-set, module-var, ns2_variable_in_module_2)

$(call anrem-ns-local-set, ns-var-mod2, ns2_ns-variable-from-mod2)


$(call anrem-test):
	$(call anrem-warn, local ns2_|MODULE 2)
	$(call anrem-assert-eq, anrem-local-get module-var in mod2, ns2_variable_in_module_2, $(call anrem-local-get, module-var)) 
	$(call anrem-assert-eq, anrem-ns-local-get ns-var-mod2, ns2_ns-variable-from-mod2, $(call anrem-ns-local-get, ns-var-mod2))
	$(call anrem-assert-eq, @ module-var in mod2, ns2_variable_in_module_2, $(@module-var)) 
