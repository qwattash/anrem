...
$(<@)
$(@)module-var := ns1_variable_in_module_4
$(@>)

$(<&)
$(&)ns-var-mod4 := ns1_ns-variable-from-mod4
$(&>)

$(call anrem-test):
	$(call anrem-warn, local ns1_|MODULE 4)
	$(call anrem-assert-eq, anrem-local-get module-var in mod4, ns1_variable_in_module_4, $(call anrem-local-get, module-var)) 
	$(call anrem-assert-eq, anrem-ns-local-get ns-var-mod4, ns1_ns-variable-from-mod4, $(call anrem-ns-local-get, ns-var-mod4))
	$(call anrem-assert-eq, @ module-var in mod4, ns1_variable_in_module_4, $(@module-var)) 
